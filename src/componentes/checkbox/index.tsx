...
export interface ICheckBoxItem { value: string; label: string; }
...
const CheckBoxList: React.FC<CheckBoxListProps> = ({ value, items, onChange}) => {
        ...
        <>
            {             
                <Select value={value}
                        ...
                        isMulti options={items} 
                        isClearable={true}
                        isSearchable={true}
                        closeMenuOnSelect={true}
                        components={animatedComponent}
                        onChange={(selectedItems) => handleCheckboxChange(selectedItems as MultiValue<ICheckBoxItem>)}
                        />          
            }
        </>            
    );
