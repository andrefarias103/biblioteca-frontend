...
import { atualizaLivro, cadastraLivro, livroPorId } from "../../../hooks/useLivros";
...
const LivroForm = () => { 
    ...
    const [livro, setLivro] = useState<TypeLivro>({nome: '', isbn: '', dataDePublicacao: '', autorPorLivros: [''] });
    ...
    const [autoresSelecionados, setAutoresSelecionados] = useState<ICheckBoxItem[]>([]); 
