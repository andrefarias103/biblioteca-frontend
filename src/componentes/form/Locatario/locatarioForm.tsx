...
import { atualizaLocatario, cadastraLocatario, locatarioPorid } from "../../../hooks/useLocatarios";
...
const LocatarioForm = () => { 
    ...
    const [locatario, setLocatario] = useState({ nome: '', sexo: '', telefone: '', email: '', dataDeNascimento: '', cpf: '' });
                ...
                <div className={style.AppStyle}>
                    <div className={style.container}>
                        <div className={style.areaCampos}>
                            ...
                            <input type="text" name="nome" value={locatario.nome}  onChange ={handleChange}></input>
                        </div>
                        <div className={style.areaCampos}>
                            <label className={style.labelForm}>Sexo:</label>
                            <select name="sexo" value={locatario.sexo} onChange={handleChange}  >
                                <option value={""}>  </option>
                        ...
                        <div className={style.areaCampos}>
                            ...
                            <input type="text" name="cpf" value={locatario.cpf}  onChange ={handleChange}></input>
                        </div>                             
                        <div className={style.areaCampos}>
                            <label className={style.labelForm}>Telefone:</label>
                            <input type="text" name="telefone" value={locatario.telefone}  onChange ={handleChange}></input>
                        </div>                  
                        <div className={style.areaCampos}>
                            <label className={style.labelForm}>E-mail:</label>
                            <input type="text" name="email" value={locatario.email}  onChange ={handleChange}></input>
                        </div>                                                     
                        <div className={style.areaCampos}>
                            <label className={style.labelForm}>Data de Nascimento:</label>
                            <input type="text" name="dataDeNascimento" value={locatario.dataDeNascimento}  onChange ={handleChange}></input>
                        </div>                                                               
                    </div>
